...
from openeqa_sceneType.evaluation.llm_match import get_llm_match_score
...
def main(args: argparse.Namespace):
    ...
    dataset_question_ids = [item["question_id"] for item in dataset if "sceneType" in item]
    question_id_to_item = {item["question_id"]: item for item in dataset if "sceneType" in item}
    print("found {:,} questions".format(len(dataset_question_ids)))
